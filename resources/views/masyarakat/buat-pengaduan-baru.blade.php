            ...
            <form action="{{ url('/masyarakat/postpengaduan') }}" method="post">
              ...
              <div class="row">
                <div class="form-group has-feedback col-md-6">
                  ...
                  <input type="text" class="form-control" value="{{ Session::get('nik') }}" readonly="">
                </div>
                <?php 
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="judul_laporan" placeholder="Masukan judul pengaduan" required="">
              </div>           
              <div class="form-group">
